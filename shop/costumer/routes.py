...
from ..import db, app, photos, search, bcrypt, login_manager
...
publishable_key ='pk_test_51IZr7wBZJ374hZvzRyhbNmlspBeM6QYuSUeujQjWSBKD1nExn49b007JMuz2AV9qsAtv0KoO4yYK9hwImDlTFTna00WWMx1vc8'
stripe.api_key ='sk_test_51IZr7wBZJ374hZvzJlGV6yenvsAv0YjmurjXPIKAFlzTi8zl4cfvTpZ0eomkggALipW92bODcnWUWkFSYA8KtvYf00loxlTGhf'
...
def get_pdf(invoice):
    if current_user.is_authenticated:
        ...
        if request.method =="POST":
            ...
            response.headers['content-Disposition'] ='attched; filename='+invoice+'.pdf'
            return response
